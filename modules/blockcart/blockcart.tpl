						...
						<div class="layer_cart_product col-xs-12 col-md-6">
							...
							{block name='blockcart_layer_cart_product_info'}
								<div class="layer_cart_product_info">
									...
									<div>
										<strong class="dark layer_cart_room_txt" data-label-occupancy="{l s='Room occupancy' mod='blockcart'}" data-label-quantity="{l s='Rooms quantity added' mod='blockcart'}">
